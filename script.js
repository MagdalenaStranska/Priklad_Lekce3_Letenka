...
document.body.innerHTML += "<p>Maximální rozměry příručního zavazadla (šířka*výška*délka): " + rozmeryZav.hand_width + "*" + rozmeryZav.hand_height + "*" + rozmeryZav.hand_length + "cm" + "</p>"
